...
The frozen USB image is **0.2.0**. Working tree / OTA latest is **0.3.0**, so a newly USB-flashed box updates on first Wi‑Fi. Firmware after `0.1.0` applies any newer X.Y.Z on boot.
