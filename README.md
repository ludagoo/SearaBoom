...
|-----------|------------|-----------------|
| New or bricked unit | Desktop flasher: one binary from https://searaboom.goossen.dev/. Run it, ARM, plug USB. Fetches the live USB image. DTR/RTS, no BOOT button. Chrome WebSerial is a fallback. | Manual flash (new/bricked units) |
...
Factory flash (new boxes): download one factory-flasher binary from https://searaboom.goossen.dev/. Chrome WebSerial remains a fallback.  
