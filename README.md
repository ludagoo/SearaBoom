...
|-----------|------------|-----------------|
| New or bricked unit | Factory TUI: paste the curl one-liner from https://searaboom.goossen.dev/ (chmod +x is in the command). Terminal UI opens. ARM, plug USB. Fetches the live USB image. DTR/RTS, no BOOT button. Chrome WebSerial is a fallback. | Manual flash (new/bricked units) |
